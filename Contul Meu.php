...
document.querySelectorAll('.dropdown > a').forEach(link => {
  link.addEventListener('click', e => {
    ...
    // Pe desktop lasam hover-ul din CSS
...
const cards = document.querySelectorAll('.card'); // înlocuiește '.account-card'
