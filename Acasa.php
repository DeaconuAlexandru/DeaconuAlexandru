...
$txt = [
    'ro'=>[
        ...
        'nav'=>['Acasă','Servicii','Colecție','Despre Noi','Contact'],
        ...
        'stats'=>['500+'=>'Clienți Mulțumiți','1000+'=>'Covoare Vândute','20+'=>'Ani Experiență'],
...
<header id="header">
  <div style="display:flex;align-items:center;justify-content:space-between;width:100%;flex-wrap:wrap;">
    ...
    <div class="header-contact">
      ...
      <a href="#contact" class="btn">Programează</a>
...
document.addEventListener("DOMContentLoaded", function(){
  ...
  // Mutare Contact pe mobil și aranjare verticală
  const nav = document.getElementById("mainNav");
  ...
  function adjustMenu(){
    if(window.innerWidth <= 768){
      ...
      nav.style.width = "100%";
      nav.style.gap = "10px";
      // Ordine: Acasă, Colecție, Despre Noi, Contact
      ['Acasa.php','Colectie.php','DespreNoi.php','Contact.php'].forEach(file => {
