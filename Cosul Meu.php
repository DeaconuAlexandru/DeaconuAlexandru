...
<td><?= $subtotal ?> Lei</td>
<td><a href="CosulMeu.php?remove=<?= $name ?>">Sterge</a></td>
</tr>
<?php endforeach; ?>

</table>
<p class="total">Total produse: <?= $total ?> Lei</p>
<p class="total">Total de plata (inclusiv livrare): <?= $total ?> Lei</p>

<!-- Butonul modifica PHP-ul pentru a salva coșul în sesiune și a redirecționa -->
<button type="submit" name="continue">Continua Comanda</button>
</form>
<?php endif; ?>
</div>
